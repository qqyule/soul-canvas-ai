...
## 🔥 2.5 版本更新 (What's New in v2.5)

v2.5 版本在 v2.0 的基础上，进一步拓展了**多模态交互**与**工程化体验**，新增了有声读物与 PDF 导出功能，让创意不再局限于屏幕。

### 🌟 核心新特性

| 特性模块        | 功能描述                                                                   |
| :-------------- | :------------------------------------------------------------------------- |
| **🎧 有声读物** | 全新 Audiobook 阅读器，支持章节跳转与自动连播，沉浸式听书体验              |
| **🗣️ 语音合成** | 集成 TTS 引擎，支持高品质中文朗读，让绘本故事“开口说话”                    |
| **📄 PDF 导出** | 一键将绘本导出为高清 PDF，完美支持中文排版，便于打印与分享                 |
| **🃏 英雄卡片** | 独特的 Hero Card 生成，将角色与故事封装为精美卡片，支持 PNG 导出与分享     |
| **🏠 官网重构** | 全新设计的 Landing Page，沉浸式视觉体验，优化 Footer 与 Style Gallery 展示 |
| **🎨 画廊升级** | Style Gallery 2.0，新增 AI 生成预览图与本地化风格描述                      |

### 🛠️ 工程化升级

- **⚡ Biome 迁移**: 全面迁移至 [Biome](https://biomejs.dev/)，统一 Linting 与 Formatting 标准。
- **🚀 依赖升级**: 核心依赖 (React, Vite, Tailwind) 全线升级至最新稳定版。
