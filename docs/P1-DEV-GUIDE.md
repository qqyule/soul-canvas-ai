...
| P1-2   | 风格选取 UI 优化   | `feature/style-ui-refine`  | ⚪ 待开始 | ⭐⭐⭐   |
...
- [ ] **图片示例**: 每个风格按钮需配一张极具代表性的 AI 生成预览图。
- [ ] **悬停预览**: 悬停在风格按钮上时，展示更大尺寸的示例图及风格说明。
- [ ] **分类导航**: 支持“写实”、“动漫”、“3D”、“艺术”等分类标签切换。
- [ ] **选中态增强**: 选中风格时，按钮应有独特的呼吸灯或边框动效。
